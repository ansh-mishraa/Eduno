...
export const subjectResources: Record<string, SubjectResources> = {
  ...
  os: {
      ...
      rgpv: [
        {
          ...
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://onedrive.live.com/embed?cid=9F0200C1153A2AA1&resid=9F0200C1153A2AA1%211080&authkey=ALkk04Zp3hZKi6w&em=2",
        },
        {
          id: "os-notes-rgpv-2",
          title: "Unit 2 - Operating System",
          contributor: "RGPV Notes",
          subjectCode: "IT-501",
          subjectName: "Operating System",
          department: "Information Technology",
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://onedrive.live.com/embed?cid=9F0200C1153A2AA1&resid=9F0200C1153A2AA1%211081&authkey=ACdXx0BC1KJhdHo&em=2",
        },
        {
          id: "os-notes-rgpv-3",
          title: "Unit 3 - Operating System",
          contributor: "RGPV Notes",
          subjectCode: "IT-501",
          subjectName: "Operating System",
          department: "Information Technology",
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://onedrive.live.com/embed?cid=9F0200C1153A2AA1&resid=9F0200C1153A2AA1%211077&authkey=AOLWxR63k_CZGSk&em=2",
        },
        {
          id: "os-notes-rgpv-4",
          title: "Unit 4 - Operating System",
          contributor: "RGPV Notes",
          subjectCode: "IT-501",
          subjectName: "Operating System",
          department: "Information Technology",
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://onedrive.live.com/embed?cid=9F0200C1153A2AA1&resid=9F0200C1153A2AA1%211079&authkey=AG6qkL25LiV9DyM&em=2",
        },
        {
          id: "os-notes-rgpv-5",
          ...
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://onedrive.live.com/embed?cid=9F0200C1153A2AA1&resid=9F0200C1153A2AA1%211078&authkey=AInuAr-tvu1d6U8&em=2",
        },
      ],
      college: [],
    },
      ...
      yearWise: [
        {
          ...
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://drive.google.com/file/d/1RdXOhsD3DpuRxpQrr1iYXm8lWnrWT6Ql/view?usp=drive_link",
        },
        {
          id: "os-pyq-nov-23",
          title: "OS PYQ November 2023",
          year: "Nov 23",
          subjectCode: "IT-501",
          subjectName: "Operating System",
          department: "Information Technology",
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://drive.google.com/file/d/1fV3xqzXHPRCia7Bxq1bpgNxk7E_g6Yvl/view?usp=drive_link",
        },
        {
          id: "os-pyq-nov-22",
          title: "OS PYQ November 2022",
          year: "Nov 22",
          subjectCode: "IT-501",
          subjectName: "Operating System",
          department: "Information Technology",
          semester: 5,
          fileType: "PDF",
          pdfUrl: "https://drive.google.com/file/d/1MlJdlIq00qHqhuht3pqNtHjVFPQ5Y4Kl/view?usp=drive_link",
        },
      ],
      unitWise: [],
    },
    ...
    important: [
      {
        unit: 0,
        title: "MOST IMPORTANT TOPICS (Exam Pattern Analysis)",
        topics: [
          "CPU Scheduling (⚠️ MOST IMPORTANT) - Appears in ALL 3 papers",
          "Deadlock (VERY HIGH) - Appears every year",
          "Memory Management - Paging & Segmentation - Appears every year",
          "Disk Scheduling (NUMERICAL FAVOURITE) - Guaranteed numerical",
          "Process Synchronization & Semaphores - Appears every year",
          "File System (CONSISTENT THEORY) - Appears every year",
          "Memory Allocation (Numerical + Theory) - Appears frequently",
        ],
        questions: [
          "If short on time, prepare CPU Scheduling + Deadlock + Disk Scheduling + Demand Paging + Semaphores",
          "These 5 topics alone can fetch 40+ marks",
        ],
      },
      {
        unit: 1,
        title: "CPU Scheduling (⚠️ HIGHEST PRIORITY)",
        topics: [
        ...
        questions: [
          "Draw Gantt chart and calculate WT & TAT (14 marks guaranteed)",
          "Compare FCFS vs RR vs Priority scheduling",
          "Which algorithm gives minimum average waiting time and why?",
          "Why new processes are added at end in Round Robin?",
        ],
      },
      {
        unit: 2,
        title: "Deadlock (VERY HIGH PROBABILITY)",
        topics: [
        ...
        questions: [
          "What are the four necessary conditions for deadlock? (6-8 marks)",
          "Explain deadlock using Dining Philosophers Problem",
          "Construct Resource Allocation Graph and detect deadlock",
      ...
      },
      {
        ...
        topics: [
          ...
          "TLB hit ratio numericals",
        ],
        questions: [
          "Explain demand paging with diagram (8-10 marks)",
          "Calculate page faults for given reference string",
          "EMAT numerical with TLB calculations",
          "Compare FIFO vs LRU vs Optimal page replacement",
        ],
      },
      {
        unit: 4,
        title: "Disk Scheduling (NUMERICAL FAVOURITE)",
        topics: [
          ...
          "LOOK algorithm", 
          "C-SCAN algorithm",
          "Total head movement calculations",
        ],
        questions: [
          "Calculate total head movement using FCFS, SSTF, SCAN (6-8 marks)",
          "Compare SCAN vs C-SCAN algorithms",
          "Which disk scheduling algorithm is best and why?",
          "Numerical on seek time and rotational delay",
        ],
      },
      {
        unit: 5,
        title: "Process Synchronization & File Systems",
        topics: [
        ...
        questions: [
          "What is critical section problem? (6-8 marks)",
          "Why semaphore operations must be atomic?",
          "Explain file allocation methods with pros & cons",
    ...
    syllabus: [
      ...
      {
        unit: 2,
        title: "CPU Scheduling and Process Management",
        topics: [
      ...
      {
        unit: 3,
        title: "Deadlock and Memory Management",
        topics: [
          "Deadlock problem",
      ...
      {
        unit: 4,
        title: "Virtual Memory and Security",
        topics: [
      ...
      {
        unit: 5,
        title: "File Systems and Distributed Systems",
        topics: [
          "Disk scheduling",
          "File concepts",
          "File manager",
